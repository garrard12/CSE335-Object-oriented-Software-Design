...
/**
 * Remover the Keyframe
 */
void AnimChannel::RemoveKeyframe()
{
	// Nothing to delete
	if(mKeyframe1 < 0)
	{
	...
	if(GetTimeline()->GetCurrentFrame() == mKeyframes[mKeyframe1]->GetFrame())
	{
 ...
 * @return True if keyframe 1 or 2 is true
 */
